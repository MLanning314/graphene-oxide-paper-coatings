...
region_results_handsheet <- distance_data_clammp |>
  filter(paper_type == "Greif") |>
...
region_summary_handsheet <- region_results_handsheet |>
...
anova_results_handsheet <- region_results_handsheet |>
  group_by(region) |>
  group_modify(~{
...
tukey_results_handsheet <- region_results_handsheet |>
  group_by(region) |>
  group_modify(~{
    fit <- aov(modulus ~ coating,
               data = .x)
